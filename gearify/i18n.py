...
class I18n:
    ...
    TRANSLATIONS: Dict[str, Dict[str, str]] = {
        ZH: {
            ...
            "chk_auto_names": "智能嗅探公文姓名（基于职务称谓与百家姓，如：联系人：张三 ➔ ××）",
            ...
            "chk_mask_ip": "IPv4 网络地址（如：192.168.1.1 ➔ ×××）",
            "chk_mask_bank_card": "银行卡与信用卡号（16~19位卡号 ➔ ×××）",
            "chk_mask_license_plate": "中国机动车号牌（蓝牌/绿牌/黄牌 ➔ ×××）",
            ...
            "status_cancelling": "正在中止脱敏任务...",
            "status_cancelled": "脱敏任务已由用户中止！成功: {0} 个，未处理: {1} 个",
            "status_finished": "脱敏任务完成！成功: {0} 个，失败: {1} 个",
            "status_deleted_items": "已从列表中移除 {0} 个文件",
            ...
            "menu_open_file": "使用默认程序打开",
            "menu_preview": "在预览区查看此文件内容",
            # 对话框
            "dlg_tip": "提示",
            "dlg_error": "错误",
        ...
        EN: {
            ...
            "chk_auto_names": "Contextual Name Sniffing (Titles & Surnames, e.g. Contact: John)",
            ...
            "chk_mask_ip": "IPv4 Network Addresses (e.g. 192.168.1.1 ➔ ×××)",
            "chk_mask_bank_card": "Bank & Credit Cards (16-19 digits ➔ ×××)",
            "chk_mask_license_plate": "Vehicle License Plates (e.g. 京A88888 ➔ ×××)",
            ...
            "status_cancelling": "Cancelling batch task...",
            "status_cancelled": "Batch task aborted! Succeeded: {0}, Skipped: {1}",
            "status_finished": "Batch complete! Succeeded: {0}, Failed: {1}",
            "status_deleted_items": "Removed {0} file(s) from list",
            "btn_open_folder": "📂 Open Folder",
            "btn_start": "🚀 Start Masking",
            "btn_stop": "⏹️ Stop Batch",
            # Context Menu
            "menu_remove": "Remove from List",
            "menu_open_dir": "Open Containing Folder",
            "menu_open_file": "Open with Default App",
            "menu_preview": "Preview File in Live Tab",
            # Dialogs
            "dlg_tip": "Notice",
            "dlg_error": "Error",
